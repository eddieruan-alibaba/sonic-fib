...
TEST(NextHopGroupFull_CAPI, multi_nexthop) {
    ...
    char* json_str = nexthopgroupfull_json_from_c_nhg_multi(&c_nhg, MULTIPATH_NUM, false);
...
TEST(NextHopGroupFull_CAPI, singleton) {
    ...
    char* json_str = nexthopgroupfull_json_from_c_nhg_singleton(&c_nhg, MULTIPATH_NUM);
